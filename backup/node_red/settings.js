...
module.exports = {
	// Admin and other user creds
    	httpStatic:"/assets/",
	httpNodeAuth: {user:"app",pass:"$2a$04$dNfQ8SFqtY.ba84M.9J8auygG.POwUK3DaL/6vKayRZSijpBxkoum"},
	adminAuth: {
        type: "credentials",
        users: [
            {
                username: "admin",
                password: "$2a$04$SIBm029JZDhgbmHoWhafieYN.c0ffqTbEGjlpHIa65KU9CNMQIBLK",
                permissions: "*"
            },
            {
                username: "app",
                password: "$2a$04$j1ulsedO/1gFzw4zi8TK2eyEaBTxrPo969a8L4DSzrRnsOrqmYcIq",
                permissions: "read"
            }
        ]
    },
